"""
NS Agent - Experimental Stub

⚠️ EXPERIMENTAL: This is NOT a canonical agent.
⚠️ This is a stub for future NS-GMI (Navier-Stokes GMI) specialized hosted process.
...
class NSAgent:
    ...
    def step(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return {"ns_gmi": "stub", "status": "not_implemented"}
    
    def __repr__(self) -> str:
        return "NSAgent(EXPERIMENTAL_STUB)"
